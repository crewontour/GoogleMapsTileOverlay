...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Bernie Del Sani" => "bernie@crewontour.com" }
  # Or just: spec.author    = "Sandro Wehrhahn"
  # spec.authors            = { "Sandro Wehrhahn" => "info@mail.com" }
  # spec.social_media_url   = "https://twitter.com/sandammeer"
  ...
  spec.source       = { :git => "https://github.com/crewontour/GoogleMapsTileOverlay.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/GoogleMapsTileOverlay"
